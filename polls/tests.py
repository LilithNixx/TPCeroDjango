...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        ...
        self.aseertIs(old_question.was_published_recently(), False)
    
    #was_published_recently() returns True for questions whose pub_date is within the last say
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question_and_pst_question(self):
        create_question(question_text= "Future question.", days=30)
        responde = self.client.get(reverse("polls:index"))
        self.assertQuerySetEqual(response.context["latest_question_list"], [Question])
